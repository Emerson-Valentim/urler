...
export const getPostAccountMutationOptions = <
  TError = unknown,
  TContext = unknown
>(options?: {
...
export type PostAccountMutationResult = NonNullable<
  Awaited<ReturnType<typeof postAccount>>
>;
 ...
 * @summary Create an account
 */
export const usePostAccount = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof postAccount>>,
      TError,
 ...
 * @summary Sign in
 */
export const postSignin = (signIn: SignIn, signal?: AbortSignal) => {
 ...
 */
export const postUrl = (createURL: CreateURL, signal?: AbortSignal) => {
...
export const getPostUrlMutationOptions = <
  TError = unknown,
  TContext = unknown
>(options?: {
  mutation?: UseMutationOptions<
...
export type PostUrlMutationResult = NonNullable<
  Awaited<ReturnType<typeof postUrl>>
>;
 ...
 * @summary Create a URL
 */
export const usePostUrl = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof postUrl>>,
      TError,
 ...
 * @summary List URLs
 */
export const getUrl = (signal?: AbortSignal) => {
  return axiosMutator<Url[]>({ url: `/url`, method: "GET", signal });
};
...
export const getGetUrlQueryOptions = <
  TData = Awaited<ReturnType<typeof getUrl>>,
  TError = unknown
>(options?: {
  query?: Partial<
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getUrl>>> = ({
    signal,
  }) => getUrl(signal);
